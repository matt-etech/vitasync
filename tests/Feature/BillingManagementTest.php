...
class BillingManagementTest extends TestCase
{
    ...
    public function test_billing_workflow_profiles_contract_charges_invoice_payment_receipt_and_audit(): void
    {
        ...
        $this->actingAs($admin)
            ...
            ->assertRedirect(route('billing.index', absolute: false));
        ...
        $this->actingAs($admin)
            ->post(route('billing.contracts.store'), [
                ...
                'late_fee_type' => 'fixed',
                'late_fee_amount' => '25',
                'care_level_pricing' => '{"standard":400}',
                'discount_type' => 'fixed',
                'discount_amount' => '80',
                'status' => 'active',
            ])
        ...
        $this->assertSame('1170.00', $invoice->total_amount);
        $this->assertSame('1170.00', $invoice->balance_due);
        ...
        $this->assertSame('700.00', $invoice->paid_amount);
        $this->assertSame('470.00', $invoice->balance_due);
